...
class VisitorServiceTest {
    ...
    private CreateContactCommand validContact() {
    ...
    void create_whenSuccess_expectReturnPerson() {
        ...
        Visitor visitor = new Visitor("Augusto João da Rosa", "11309929939", LocalDate.of(1959, 3, 20), VisitorType.RELATED);
    ...
    void create_whenExistentPerson_expectReturnPerson() {
        CreateVisitorCommand request = validVisitorCommand();
        Visitor visitor = new Visitor("Camila Eliane Marina Farias", "11309929939", LocalDate.of(1960, 3, 5), VisitorType.RELATED);
